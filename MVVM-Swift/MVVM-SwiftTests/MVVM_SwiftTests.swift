...
class MVVM_SwiftTests: XCTestCase {
    ...
    func testCarViewModelWithFerrariF12() {
        let ferrariF12 = Car(model: "F12", make: "Ferrari", kilowatts: 100, photoURL: "http://auto.ferrari.com/en_EN/wp-content/uploads/sites/5/2013/07/Ferrari-F12berlinetta.jpg")
        ...
        XCTAssertEqual(ferrariViewModel.horsepowerText, "134 HP")
